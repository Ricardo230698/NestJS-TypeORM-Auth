...
@Injectable()
export class LocalStrategy extends PassportStrategy(Strategy, 'local') { // El nombre 'local' identifica esta estrategia en NestJS y permite usarla en otras partes de la aplicación (como en AuthGuard('local')).
