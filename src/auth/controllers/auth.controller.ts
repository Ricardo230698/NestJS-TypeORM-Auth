...
export class AuthController {
    ...
    login(@Req() req: Request) {
        return req.user; // El método validate de LocalStrategy: Si encuentra al usuario y las credenciales son correctas, devuelve el usuario. Passport toma el valor devuelto por validate y lo asigna a req.user.
    }
}
